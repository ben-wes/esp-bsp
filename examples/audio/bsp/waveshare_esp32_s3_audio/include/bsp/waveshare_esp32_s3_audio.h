...
#define BSP_POWER_AMP_IO     (56)  /* TCA9555 EXIO8 (port1 bit0), virtual GPIO via IO expander wrapper */
/** @} */
 ...
 *  @{
 */
/* LCD pins exposed on the 18-pin FPC / pin header connector */
#define BSP_LCD_PCLK         (GPIO_NUM_6)
#define BSP_LCD_DATA0        (GPIO_NUM_7)
#define BSP_LCD_DC           (GPIO_NUM_4)
#define BSP_LCD_CS           (GPIO_NUM_5)
#define BSP_LCD_RST          (57)  /* TCA9555 EXIO9 virtual GPIO */
#define BSP_LCD_BACKLIGHT    (58)  /* TCA9555 EXIO10 virtual GPIO */
#define BSP_LCD_EN           (58)  /* Same as backlight for enable control */
#define BSP_LCD_TOUCH_INT    (GPIO_NUM_NC)
#define BSP_TOUCH_EN         (58)  /* Same as LCD_EN */
/** @} */
 ...
 *  @{
 */
/* Camera pins exposed on the 24-pin DVP header */
#define BSP_CAMERA_GPIO_XCLK (GPIO_NUM_40)
#define BSP_CAMERA_RST       (GPIO_NUM_NC)
#define BSP_CAMERA_PCLK      (GPIO_NUM_42)
#define BSP_CAMERA_VSYNC     (GPIO_NUM_41)
#define BSP_CAMERA_HSYNC     (GPIO_NUM_39)
#define BSP_CAMERA_D0        (GPIO_NUM_21)
#define BSP_CAMERA_D1        (GPIO_NUM_47)
#define BSP_CAMERA_D2        (GPIO_NUM_48)
#define BSP_CAMERA_D3        (GPIO_NUM_45)
#define BSP_CAMERA_D4        (GPIO_NUM_46)
#define BSP_CAMERA_D5        (GPIO_NUM_3)
#define BSP_CAMERA_D6        (GPIO_NUM_8)
