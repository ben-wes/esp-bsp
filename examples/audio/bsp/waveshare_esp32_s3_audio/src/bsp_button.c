 ...
 */
#define BSP_BUTTON_K1_IO  (48 + 0)  /* TCA9555 P0_0 -> virtual GPIO */
#define BSP_BUTTON_K2_IO  (48 + 1)  /* TCA9555 P0_1 -> virtual GPIO */
#define BSP_BUTTON_K3_IO  (48 + 2)  /* TCA9555 P0_2 -> virtual GPIO */
